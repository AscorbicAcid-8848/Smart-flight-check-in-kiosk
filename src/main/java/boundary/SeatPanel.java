...
public class SeatPanel extends JPanel implements ActionListener{
    ...
    public void render(ArrayList<Seat> s, Passenger p, int initPrice, int airline){
        ImageIcon airlineImg = null;
        JLabel welcome = new JLabel();
        if(airline == 1){ airlineImg = new ImageIcon("src/main/java/boundary/images/britishAirway.png"); welcome.setText("Welcome to British Airway!");}
        if(airline == 2){ airlineImg = new ImageIcon("src/main/java/boundary/images/easternAirway.png" ); welcome.setText("Welcome to Eastern Airway!");}
        ...
        if(airline == 4){ airlineImg = new ImageIcon("src/main/java/boundary/images/airChina.png"); welcome.setText("Welcome to Air China!");}
        JLabel imgLabel = new JLabel();
